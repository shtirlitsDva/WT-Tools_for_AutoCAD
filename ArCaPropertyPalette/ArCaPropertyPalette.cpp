...
//-----------------------------------------------------------------------------
//- ArCaPropertyPalette.cpp : Initialization functions
//-----------------------------------------------------------------------------
#include "StdAfx.h"
#include "resource.h"
#include <initguid.h>
...
#include <afxdllx.h>
#include "ArCaPropertyPalette_i.c"
#include "axdb_i.c"


//-----------------------------------------------------------------------------
class CArCaPropertyPaletteModule : public CAtlDllModuleT<CArCaPropertyPaletteModule> {

public :
	DECLARE_LIBID(LIBID_ArCaArCaPropertyPaletteLib)
	DECLARE_REGISTRY_APPID_RESOURCEID(IDR_ARCAPROPERTYPALETTE, "{84DB4B58-CA53-4DF6-AD6A-3440CC134304}")
} ;

CArCaPropertyPaletteModule _AtlModule ;

//-----------------------------------------------------------------------------
//- Define the sole extension module object.
AC_IMPLEMENT_EXTENSION_MODULE(ArCaPropertyPaletteDLL)
...
#ifdef NEVER
AFX_EXTENSION_MODULE ArCaPropertyPaletteExtDLL ={ NULL, NULL } ;
#endif
...
BOOL WINAPI DllMain (HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved) {
	...
	if ( dwReason == DLL_PROCESS_ATTACH ) {
		...
		ArCaPropertyPaletteDLL.AttachInstance (hInstance) ;
	} else if ( dwReason == DLL_PROCESS_DETACH ) {
		ArCaPropertyPaletteDLL.DetachInstance () ;
	}
